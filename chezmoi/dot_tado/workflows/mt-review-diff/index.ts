import type { WorkflowDef, CheckCtx, PromptCtx, CheckResult, ArtifactRecord } from "tado";
...
export const resolveEffortStep = def.steps[0];
export const collectContextStep = def.steps[1];
export const runReviewersStep = def.steps[2];
export const normalizeFindingsStep = def.steps[3];
export const startDifitReviewStep = def.steps[4];
export const awaitHumanReviewStep = def.steps[5];
export const collectVerdictStep = def.steps[6];
