...
import type { MtPlanConfig, PlanStatus } from "../shared/plan-init-config/types";
import { PLAN_STATUSES } from "../shared/plan-init-config/plan-statuses";
import { InitConfigError } from "../shared/plan-init-config/init-config-error";
import { runCommand } from "../shared/plan-init-config-gh/run-command";
import { GitCommandError } from "../shared/plan-init-config-gh/git-command-error";
...
export function usage(): string {
  return [
    ...
    "Config is loaded from ~/.config/mt-plan/config.json (see ../shared/plan-init-config.ts).",
    "",
