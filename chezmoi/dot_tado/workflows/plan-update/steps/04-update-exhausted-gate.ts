...
// -----------------------------------------------------------------
export const updateExhaustedGateStep: HumanGateStepDef = {
  key: "update-exhausted",
  phase: "更新上限到達判断",
  type: "human_gate",
  maxRetries: 1,
  onFail: { action: "abort" },
  condition: (ctx: ConditionCtx): boolean =>
    isLoopExhausted(ctx.sessionDir, "update-cycle-exhausted.json", "update-cycle"),
        ...
        choices: [
          {
            ...
            desc: "未反映の指摘を残したまま update-issue へ進む",
