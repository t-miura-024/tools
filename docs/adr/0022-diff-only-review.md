...
- **実装範囲**: `workflows/mt-review-diff/index.ts`（`run_reviewers` / `normalize_findings` プロンプト）、`_shared/mt-review-helpers.ts`（純粋関数・validate・difit コメント変換）、`agents/mt-review-diff-reviewer.md`（3箇所同期）、本 ADR。
